      ...
      <main className="flex-1 container px-4 py-6 grid grid-cols-[400px,1fr] gap-6">
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <Button className="w-full bg-purple-500 hover:bg-purple-600">Submit</Button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" className="flex-1 bg-[#22262b] border-0 text-gray-200">
                Choose File
              </Button>
              <Button size="icon" className="bg-purple-500 hover:bg-purple-600">
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={metric.label} className="space-y-2">
                    ...
                    <Progress value={metric.value * 10} className="bg-purple-500/20" />
                  </div>
                ))}
              </div>
            </div>
